...
export const Insights = () => {
  ...
  const items = t('insights.items', { returnObjects: true, defaultValue: [] }) as InsightItem[];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {items.map((item, itemIndex) => (
            <a key={itemIndex} href={item.url} className="block bg-[#FEFAF6] p-6 rounded-lg hover:shadow-md transition-shadow">
