...
export interface PsychologistSeedTransaction {
    resetFeaturedOrders?(): Promise<void>;
...
const gisellaBio = {
    shortBio: {
        en: 'Gisella Tani Pratiwi (Ella) is a clinical psychologist practicing since 2010. She supports adolescents, young adults, and parents through trauma recovery, emotional regulation, and self-empowerment with a warm, non-judgmental approach.',
        id: 'Gisella Tani Pratiwi (Ella) adalah psikolog klinis yang berpraktik sejak 2010. Ia mendampingi remaja, dewasa muda, dan orang tua memproses luka trauma, regulasi emosi, serta membangun resiliensi melalui ruang aman tanpa penghakiman.'
    },
    biography: {
...
const nichiBio = {
    shortBio: {
        en: 'Dwi Ningsih (Nichi) is a clinical psychologist supporting young people through emotional struggles, relationship dynamics, and life transitions. Her approach is warm, practical, and tailored to help clients discover their inner strengths.',
        id: 'Dwi Ningsih (Nichi) adalah psikolog yang berfokus mendampingi orang-orang muda menghadapi dinamika emosi, relasi, dan tantangan hidup. Pendekatannya hangat, praktis, dan adaptif untuk membantu klien menemukan kekuatan diri.'
    },
    biography: {
...
const dominikaBio = {
    shortBio: {
        en: 'Dominika Arthalia (Domi) is an educational psychologist working with children, adolescents, and families on learning challenges, motivation, and parenting dynamics. Her holistic approach nurtures every learner to thrive at their own unique pace.',
        id: 'Dominika Arthalia (Domi) adalah psikolog pendidikan yang mendampingi anak, remaja, dan keluarga menghadapi tantangan belajar, motivasi, dan pola asuh. Pendekatan holistiknya membantu setiap anak bertumbuh sesuai potensi alaminya.'
    },
    biography: {
...
const gitaBio = {
    shortBio: {
        en: 'Gita is an Adult Clinical Psychologist with a deep curiosity for people and the stories beneath their patterns. Warm, candid, and reflective, she sees therapy as a space to make sense of what keeps returning, understand ourselves with greater tenderness, and slowly create more freedom in choosing how we want to live.',
        id: 'Gita adalah Psikolog Klinis Dewasa dengan keingintahuan mendalam terhadap manusia dan kisah di balik pola-pola perilaku mereka. Hangat, jujur, dan reflektif, ia memandang terapi sebagai ruang untuk memaknai apa yang terus kembali, memahami diri dengan lebih lembut, dan perlahan menciptakan kebebasan dalam memilih cara kita ingin menjalani hidup.'
    },
    biography: {
        en: `There are moments in life when we begin to notice that some things keep finding their way back to us. A familiar feeling in a different relationship, the same fear wearing a different face, or a question about ourselves that quietly follows us from one chapter of life to another. Sometimes nothing is terribly wrong. We simply arrive at a point where the way we have always understood ourselves no longer feels enough.\n\nThese are the kinds of conversations Anggita Hotna Panjaitan, or Gita, finds especially meaningful.\n\nGita is an Adult Clinical Psychologist with a particular interest in the inner workings of adulthood: emotions, relationships, personality, trauma, ADHD, identity, work, and the often-complicated process of becoming more at home with oneself. She works with adults experiencing anxiety and mood difficulties, ADHD-related concerns, personality and relational dynamics, trauma, self-development, family and romantic relationship issues, and workplace stress.\n\nBut psychology is only one of the languages through which Gita understands people.\n\nA lifelong observer of human stories, she has an enduring love for books, writing, culture, travel, and deep conversations. She is interested in the seemingly ordinary things through which people often reveal something important about who they are. Her professional journey has been similarly varied, spanning clinical practice, organizational psychology, research, corporate mental health, writing, psychoeducation, and public speaking. She has also worked beyond the therapy room as an author and mental-health source for Indonesian media.\n\nPerhaps because of this, Gita rarely sees people as a collection of symptoms to be fixed. She is interested in the story underneath them: where a pattern came from, what once made it necessary, why it keeps returning, and whether it still belongs in the life someone wants to build.\n\nHer therapeutic style is warm and deeply curious, but also candid. Sessions with Gita can move between difficult emotions, psychological patterns, practical questions, unexpected connections, and occasionally humour. She believes therapy can be compassionate without avoiding uncomfortable truths, and psychologically deep without becoming detached from real life.\n\nFor Gita, good therapy is not about telling someone who they should become. It is about helping them understand themselves deeply enough to have more freedom in deciding who they want to be.`,
        id: `Ada momen dalam hidup ketika kita mulai menyadari bahwa ada hal-hal tertentu yang terus kembali. Perasaan yang sama di hubungan yang berbeda, ketakutan serupa dengan wajah baru, atau pertanyaan tentang diri sendiri yang diam-diam mengikuti dari satu babak kehidupan ke babak lainnya. Terkadang tidak ada yang benar-benar salah. Kita sekadar tiba di titik di mana cara kita selama ini memahami diri sendiri sudah tidak lagi terasa cukup.\n\nPercakapan semacam inilah yang bagi Anggita Hotna Panjaitan, atau Gita, terasa paling bermakna.\n\nGita adalah Psikolog Klinis Dewasa dengan minat mendalam pada dinamika internal kehidupan orang dewasa: emosi, relasi, kepribadian, trauma, ADHD, identitas, pekerjaan, dan proses yang seringkali rumit untuk merasa lebih nyaman dengan diri sendiri. Ia mendampingi orang dewasa yang mengalami kesulitan kecemasan dan suasana hati, permasalahan terkait ADHD, dinamika kepribadian dan relasi, trauma, pengembangan diri, isu keluarga dan hubungan romantis, serta stres di tempat kerja.\n\nNamun psikologi hanyalah salah satu bahasa yang Gita gunakan untuk memahami manusia.\n\nSebagai pengamat cerita manusia seumur hidup, ia memiliki kecintaan mendalam terhadap buku, tulisan, budaya, perjalanan, dan percakapan yang bermakna. Ia tertarik pada hal-hal yang tampak biasa tetapi sering kali mengungkapkan sesuatu yang penting tentang siapa seseorang sebenarnya. Perjalanan profesionalnya pun beragam, meliputi praktik klinis, psikologi organisasi, riset, kesehatan mental korporat, kepenulisan, psikoedukasi, dan public speaking. Ia juga berkarya di luar ruang terapi sebagai penulis dan narasumber kesehatan mental untuk media Indonesia.\n\nMungkin karena itulah Gita jarang melihat seseorang sebagai kumpulan gejala yang perlu diperbaiki. Ia lebih tertarik pada cerita di baliknya: dari mana sebuah pola berasal, apa yang dulu membuatnya diperlukan, mengapa ia terus kembali, dan apakah pola itu masih sesuai dengan kehidupan yang ingin dibangun seseorang.\n\nGaya terapeutik Gita hangat dan penuh keingintahuan, namun juga lugas. Sesi bersama Gita bisa bergerak antara emosi yang berat, pola psikologis, pertanyaan praktis, koneksi tak terduga, dan sesekali humor. Ia percaya terapi bisa penuh welas asih tanpa menghindari kebenaran yang tidak nyaman, dan mendalam secara psikologis tanpa terlepas dari realitas kehidupan sehari-hari.\n\nBagi Gita, terapi yang baik bukan tentang mengatakan kepada seseorang siapa yang seharusnya ia menjadi. Terapi adalah tentang membantu mereka memahami diri sendiri dengan cukup mendalam untuk memiliki kebebasan lebih dalam memutuskan ingin menjadi siapa.`
    },
    availabilityMessage: {
        id: 'Hubungi admin Attentive.id untuk informasi ketersediaan jadwal bersama Gita.',
        en: 'Contact the Attentive.id admin for current schedule availability with Gita.'
    }
};
...
export async function seedPsychologists(
    ...
    try {
        return await database.transaction(async (transaction) => {
            if (transaction.resetFeaturedOrders) {
                await transaction.resetFeaturedOrders();
            }
...
export const createDrizzlePsychologistSeedDatabase = (
    ...
    transaction: (operation) => database.transaction(async (transaction) => operation({
        resetFeaturedOrders: async () => {
            await transaction
                .update(schema.psychologists)
