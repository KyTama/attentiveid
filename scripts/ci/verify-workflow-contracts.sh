...
grep -q 'Smoke test hardened images' "$root_dir/.github/workflows/build-images.yml"
grep -q 'scripts/ci/smoke-images.sh' "$root_dir/.github/workflows/build-images.yml"
