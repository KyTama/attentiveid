...
requireValue(value.github?.required_reviewer === true, "required reviewer protection is required");
requireValue(value.github?.prevent_self_review === true, "prevent self-review must be enabled");
